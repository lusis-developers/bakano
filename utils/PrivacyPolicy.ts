export const relevantInformation = `INFORMACIÓN RELEVANTE
...
necesario para la compra de alguno de nuestros productos. www.bakano.ec no
...
sitio web, están sujetas a un proceso de confirmación y verificación, el cual
podría incluir la verificación del stock y disponibilidad de producto, validación de
la forma de pago, validación de la factura (en caso de existir) y el cumplimiento
de las condiciones requeridas por el medio de pago seleccionado. En algunos
...
export const license = `LICENCIA

BAKANO AGENCY a través de su sitio web concede una licencia para que los
usuarios utilicen los productos que son vendidos en este sitio web de acuerdo
a los Términos y Condiciones que se describen en este documento.`

export const unauthorizedUse = `USO NO AUTORIZADO
...
export const property = `PROPIEDAD
...
propiedad de los proveedores del contenido. En caso de que no se especifique
...
export const refundAndGuaranteePolicy = `POLÍTICA DE REEMBOLSO Y GARANTÍA
...
productos que pudieran tener garantía y posibilidad de reembolso pero este
será especificado al comprar el producto. En tales casos la garantía solo
cubrirá fallas de fábrica y sólo se hará efectiva cuando el producto se haya
usado correctamente. La garantía no cubre averías o daños ocasionados por
uso indebido. Los términos de la garantía están asociados a fallas de
fabricación y funcionamiento en condiciones normales de los productos y sólo
se harán efectivos estos términos si el equipo ha sido usado correctamente.
Esto incluye:
...
export const antiFraudCheck = `COMPROBACIÓN ANTIFRAUDE
...
export const privacyPolicy  = `PRIVACIDAD

Este www.bakano.ec garantiza que la información personal que usted envía
...
La suscripción a boletines de correos electrónicos publicitarios es voluntaria y
podría ser seleccionada al momento de crear su cuenta.

BAKANO AGENCY reserva los derechos de cambiar o de modificar estos
